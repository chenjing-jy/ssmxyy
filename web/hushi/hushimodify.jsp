...
<head>
    ...
    <script language="javascript">
        function checkDo() {
            ...
            form.action = "<%=request.getContextPath()%>/hushi/update";
            form.submit();
        }
        ...
        function checkRe() {
            ...
            xhr.open("GET","${pageContext.request.contextPath}/hushi/noRepeat?yhm="+yhm)
            xhr.send()
        }
            ...
            <TABLE cellSpacing=0 cellPadding=2 width="100%" align=center border=0>
                ...
                <tr>
                    ...
                    <td><input id="wszz" type="password" name="mm" placeholder="输入密码" class="input"
                               style="FONT-SIZE: 12px; WIDTH: 300px" value="${mm}"onfocus="show1()" onblur="hide1()"/><i> <font color="red">*</font> </i>
                    </td>
                ...
                <tr>
                    ...
                    <td><input onblur="checkPhone(this)" id="phoneInfo" type="text" name="lxdh" placeholder="输入联系电话" class="input"
