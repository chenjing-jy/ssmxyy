...
<head>
    ...
    <script language="javascript">
        function checkDo() {
            ...
            form.action = "<%=request.getContextPath()%>/bingchuang/add";
            form.submit();
        }
        function checkRe() {
        ...
        <div class=tablezone>
            ...
            <TABLE cellSpacing=0 cellPadding=2 width="100%" align=center border=0>
                ...
                <tr>
                    ...
                    <td><input readonly title="病床初始状态只能是正常" type="text" name="zt" placeholder="输入状态" class="input noOperation"
                               style="FONT-SIZE: 12px; WIDTH: 300px" value="正常"/><i> <font color="red">*</font> </i>
                    </td>
