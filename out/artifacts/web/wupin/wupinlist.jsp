...
<form name="form" action="<%=request.getContextPath()%>/wupin/listpage" method="post">
        ...
        <tr>
            <td height="565" align="center" valign="top" class="bg_low">
                <table width="100%" height="25" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td align="left" valign="middle" class="bgtop"><font color=""><b>物品列表</b></font>
                            物品<input type="text" name="wp" value="">
                ...
                <TABLE cellSpacing=0 cellPadding=3 width="100%" align=center border=1 bordercolor="#33CCCC" id="table1">
                    ...
                    <tr align="center" bgcolor="#ebf0f7">
                        ...
                        <td width="9%" height="25"><strong>物品</strong></td>

                        <td width="9%" height="25"><strong>说明</strong></td>

                        <td width="9%" height="25"><strong>数量</strong></td>

                        <td width="9%" height="25"><strong>厂家</strong></td>

                        <td width="9%" height="25"><strong>规格</strong></td>
                    ...
                    <c:forEach items="${list}" var="mymap" varStatus="status">
                        <tr align='center' bgcolor='#FFFFFF' onmouseover='this.style.background="#F2FDFF"'
                            ...
                            <td align="center" height="28">${mymap.wp}</td>
                            <td align="center" height="28">${mymap.sm}</td>
                            <td align="center" height="28">${mymap.sl}</td>
                            <td align="center" height="28">${mymap.cj}</td>
                            <td align="center" height="28">${mymap.gg}</td>

                            <td><a href="<%= request.getContextPath()%>/wupin/del?keyid=${mymap.wpid}"
                                   onClick="javascript:if(confirm('是否删除')){return true;} else{return false;}">删除</a>|
                                <a href="<%= request.getContextPath()%>/wupin/modifypage?keyid=${mymap.wpid}">修改</a>|<a
                                        href="<%= request.getContextPath()%>/wupin/detail?keyid=${mymap.wpid}">详情</a>
                            </td>
