...
<head>
    ...
    <script>
        ...
        //     if (document.getElementById("wszz").type = "text"){
        //         document.getElementById("wszz").type = "password"
        //         document.getElementById("wszz1").innerHTML = "显示密码"
        //     }else{
        //         document.getElementById("wszz").type = "text"
        //         document.getElementById("wszz1").innerHTML = "隐藏密码"
        //     }
        // }
        function show1() {
            document.getElementById("wszz").type = "text"
        ...
        <div class=tablezone>
            ...
            <TABLE cellSpacing=0 cellPadding=2 width="100%" align=center border=0>
                ...
                <tr>
                    ...
                    <td><input type="password" id="wszz" name="mm" placeholder="输入密码" class="input"
