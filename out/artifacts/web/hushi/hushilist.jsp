...
<form name="form" action="<%=request.getContextPath()%>/hushi/listpage" method="post">
        ...
        <tr>
            <td height="565" align="center" valign="top" class="bg_low">
                <table width="100%" height="25" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td align="left" valign="middle" class="bgtop"><font color=""><b>护士列表</b></font>
                            用户名<input type="text" name="yhm" value="">
                            科室<input type="text" name="ks" value="">
                ...
                <TABLE cellSpacing=0 cellPadding=3 width="100%" align=center border=1 bordercolor="#33CCCC" id="table1">
                    ...
                    <tr align="center" bgcolor="#ebf0f7">
                        ...
                        <td width="9%" height="25"><strong>联系电话</strong></td>

                        <td width="9%" height="25"><strong>联系地址</strong></td>

                        <td width="9%" height="25"><strong>科室</strong></td>
                    ...
                    <c:forEach items="${list}" var="mymap" varStatus="status">
                        <tr align='center' bgcolor='#FFFFFF' onmouseover='this.style.background="#F2FDFF"'
                            ...
                            <td id="mmHidden" align="center" height="28">******</td>
                            <td align="center" height="28">${mymap.xm}</td>
                            <td align="center" height="28">${mymap.lxdh}</td>
                            <td align="center" height="28">${mymap.lxdz}</td>
                            <td align="center" height="28">${mymap.ks}</td>

                            <td><a href="<%= request.getContextPath()%>/hushi/del?keyid=${mymap.hsid}"
                                   onClick="javascript:if(confirm('是否删除')){return true;} else{return false;}">删除</a>|
                                <a href="<%= request.getContextPath()%>/hushi/modifypage?keyid=${mymap.hsid}">修改</a>|<a
                                        href="<%= request.getContextPath()%>/hushi/detail?keyid=${mymap.hsid}">详情</a>
                            </td>
