        ...
        <tr>
            <td height="565" align="center" valign="top" class="bg_low">
                <table width="100%" height="25" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td align="left" valign="middle" class="bgtop"><font color=""><b>清单明细列表</b></font>
                            清单<input type="text" name="qd" value="">


                            类型<input type="text" name="lx" value="">
                ...
                <TABLE cellSpacing=0 cellPadding=3 width="100%" align=center border=1 bordercolor="#33CCCC" id="table1">
                    ...
                    <tr align="center" bgcolor="#ebf0f7">
                        ...
                        <td width="9%" height="25"><strong>清单</strong></td>
                        ...
                        <td width="9%" height="25"><strong>用法</strong></td>
                    ...
                    <c:forEach items="${list}" var="mymap" varStatus="status">
                        <tr align='center' bgcolor='#FFFFFF' onmouseover='this.style.background="#F2FDFF"'
                            ...
                            <td align="center" height="28">${mymap.qd}</td>
                            ...
                            <td><a href="<%= request.getContextPath()%>/qdmx/del?keyid=${mymap.qdmxid}"
                                   onClick="javascript:if(confirm('是否删除')){return true;} else{return false;}">删除</a>|
                                <a href="<%= request.getContextPath()%>/qdmx/modifypage?keyid=${mymap.qdmxid}">修改</a>|<a
                                        href="<%= request.getContextPath()%>/qdmx/detail?keyid=${mymap.qdmxid}">详情</a>
                            </td>
